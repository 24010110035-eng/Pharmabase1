...
<nav class="navbar navbar-light bg-white border-bottom sticky-top px-3">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            ...
            <?php else: ?>
            <li><a class="dropdown-item" href="<?= site_url('profil') ?>"><i class="bi bi-person me-2"></i>Profil Saya</a></li>
            <li><hr class="dropdown-divider"></li>
            <?php endif; ?>
...
<div class="d-flex">
    ...
    <aside class="sidebar p-3" id="sidebarMenu">
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <?php else: ?>
            <li class="nav-item">
                <a href="<?= site_url('profil') ?>" class="nav-link d-flex align-items-center <?= (strpos($current_url, 'profil') === 0) ? 'active' : '' ?>">
                    <i class="bi bi-person me-2"></i> Profil Saya
                </a>
            </li>
            <?php endif; ?>
