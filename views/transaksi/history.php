                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if ($role === 'admin' || $role === 'apoteker'): ?>
                            <td class="text-muted">
                                <?php if ($t->is_self_checkout): ?>
                                <span class="badge bg-info-subtle text-info">Mandiri</span>
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                <span class="badge bg-light text-dark border">
                                    <?= $label_metode[$t->metode_pembayaran] ?? '-' ?>
                                </span>
                            </td>
                            ...
                            <td class="text-end">
                                <a href="<?= site_url('transaksi/struk/' . $t->id) ?>" target="_blank" class="btn btn-sm btn-outline-secondary">
